"""
DeBERTa/DistilBERT ABSA model wrapper.
Loads the fine-tuned challenger checkpoint for inference.
"""
...
class DeBERTaABSA:
    """Wrapper for fine-tuned challenger sentiment classifier."""

    def __init__(self, checkpoint_dir: str = "models/checkpoints/deberta_absa/best"):
    ...
    def _load_from_checkpoint(self):
        ...
        logger.info(f"Challenger model loaded from {self.checkpoint_dir}")
